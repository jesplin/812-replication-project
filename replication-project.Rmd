...
Our main results presented in Figure 1 confirm the original authors’ “Elite Common Religious Identity Hypothesis” (Siegal & Badaan, 2020, p. 841). This hypothesis states that receiving a message that primes a common religious identity while also highlighting religious elite support will decrease the user’s likelihood of sending sectarian hate tweets in the future. The message in this treatment was the following: "Many religious leaders say that language sows (sectarian) discord/strife. We are all Muslim." (Siegal & Badaan, 20202, p. 843). \par
